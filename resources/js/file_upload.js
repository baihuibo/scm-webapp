...
function setoperimgbox(){
    ...
    $("#operimg_box").css("left",ob_left).css("top",ob_top);//set the position of img box
    var imgwidth=$("#show_img").width();
    var imgheight=$("#show_img").height();
    $("#show_img").css("margin-left",(600-imgwidth)/2).css("margin-top",(450-imgheight)/2);//set the position of img with zoomout
    $("#mask_bg").show();
    $("#operimg_box").show();
}
