...
$('#J_dataTable').bootstrapTable({ 
			url:basePath + '/perf/setRuleDetail/getPerformanceVersionToDetailP',
			...
			columns:[			         
			      	    {field: 'ruleVersionId', title: '序号', align: 'center',
			      	    	formatter: function(value, row, index) {	
			      				var html = '';
			      				var url = '';
			      				url = basePath+'/perf/setRuleDetail/toDdepartmentPu?ruleVersionId='+row.ruleVersionId+'&companyId='+companyId;
 ...
 $('#J_dataTable').bootstrapTable('refresh',{ url: basePath + '/perf/setRuleDetail/getPerformanceVersionToDetailP'});
/*新增部门规则*/
