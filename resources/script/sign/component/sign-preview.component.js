...
(function () {
    ...
    /**
     * @name signPreviewLayer  租赁合同预览
     * @description 通过此组件可以方便的预览合同样子和打印合同
     * @example
     * <example>
     *     <file name="test.js">
     *         function Ctrl(signUtil) {
     *             signUtil.openLayer('signPreviewLayer', data, canPrintPromise , '预览合同')
     *        }
     *     </file>
     * </example>
     */
        .component('signPreviewLayer', {
            ...
            controller: ['$element', 'signUtil', function ($element, signUtil) {
                var $ctrl = this;
                $ctrl.$start = function ($defer, data, canPrintFn, title, formal) {
                    $ctrl.data = data;
                    $ctrl.formal = formal;
                    // 载入预览样式
                    signUtil.importedCss(basePath + '/resources/css/contract-preview.css');
                        ...
                        canPrintFn().then(function (result) {
                            ...
                            if (typeof jatoolsPrinter.print !== 'undefined' && typeof jatoolsPrinter.printPreview !== 'undefined') {
                                var myDoc = {
                                    ...
                                    importedStyle: [basePath + '/resources/css/contract-print.css'],
                                    settings: {
                                        copies: 1, // 打印几份
                                    },
