...
$(document).delegate(
		...
		'click',
	      function(){
			$.ajax({
    			url: basePath+'/house/inquisitionCtf/inqCancles',
    		    type: 'GET',
    		    ...
    		    success:function(result){
    	    		...
    	    		if(result.code==1){
    	    			...
    	    			//var inquId=result.data.inquId;
    	    			//window.open("/sales/house/inquisition/inqCheckPage.html?inquId="+inquId);// 出现浏览器拦截现象
    	    			window.close();//关闭当前窗口
